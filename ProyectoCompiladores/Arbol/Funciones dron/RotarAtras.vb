Public Class RotarAtras
    Implements Instruccion
    Public Sub New()
        Form1.txt_Ejecucion.Text &= "Constructor Rotar Atras" & Environment.NewLine
    ...
    Public Function Ejecutar(ts As TablaSimbolos) As Object Implements Instruccion.Ejecutar
        Form1.txt_Ejecucion.Text &= "Rotar atras al dron ..." & Environment.NewLine
        Return Nothing
    End Function
End Class
