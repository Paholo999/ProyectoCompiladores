...
Public Class TablaSimbolos
    ...
    Public Function GetValor(id As String) As Object
        For Each simbolo As Simbolo In Me
            If simbolo.Id.Equals(id) Then
                Form1.txt_Ejecucion.Text &= " " & Environment.NewLine & "Se declaro correctamente la variable: " & simbolo.Id & Environment.NewLine
                Return simbolo.Id
            End If
        Next
        'MsgBox("La variable con el ID: " + id + " no existe.")
        Form1.txt_Ejecucion.Text &= " " & Environment.NewLine & "No se declaro correctamente la variable: " & id & Environment.NewLine
        Return "Desconocido"
    End Function

    Public Function GetMetodo(id As String) As Object
        For Each simbolo As Simbolo In Me
            If simbolo.Id.Equals(id) Then
                Form1.txt_Ejecucion.Text &= " " & Environment.NewLine & "Se declaro correctamente el metodo: " & simbolo.Id & Environment.NewLine
                Return simbolo.Id
            End If
        Next
        'MsgBox("La variable con el ID: " + id + " no existe.")
        Form1.txt_Ejecucion.Text &= " " & Environment.NewLine & "No se declaro correctamente el metodo: " & id & Environment.NewLine
        Return "Desconocido"
    End Function
    ...
    Public Sub SetValor(id As String, valor As Object)
        For Each simbolo As Simbolo In Me
            ...
            End If
        Next
        MsgBox("La variable con el ID: " + id + " no existe, no se le puede asignar un valor")
    End Sub
