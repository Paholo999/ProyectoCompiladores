...
Module MyParser
    ...
    Public dicSimbolos As DiccionarioSimbolos
    ...
    Private Enum ProductionIndex
        ...
        [Methoddeclaration_Void_Method_Lparen_Rparen_Lbrace_Rbrace_Semi] = 10 ' <MethodDeclaration> ::= void METHOD '(' ')' '{' <Program> '}' ';'
    ...
    Public Sub Setup()
        ...
        Parser.LoadTables(Path.Combine(Application.StartupPath, "Gramatica_dron_test.egt"))
    End Sub

    Public Function Parse(ByVal Reader As TextReader) As Boolean
        'El procedimiento inicia el motor analizador GOLD y gestiona los mensajes devueltos, creando nuevos objetos personalizados si es necesario. El resultado es un árbol de representación pura del lenguaje listo para implementar.
        ...
        With Reduction
            Select Case .Parent.TableIndex
                ...
                Case ProductionIndex.Methoddeclaration_Void_Method_Lparen_Rparen_Lbrace_Rbrace_Semi
                    ' <MethodDeclaration> ::= void METHOD '(' ')' '{' <Program> '}' ';' 
